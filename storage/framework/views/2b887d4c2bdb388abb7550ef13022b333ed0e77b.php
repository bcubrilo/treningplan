        ...
        <div class="container">
            <div class="header-container header">
                ...
                <div class="header-right">
                    <?php if(Auth::check()): ?>
                        <a class="navbar-item" href="<?php echo e(route('app')); ?>">Plan</a>
                    <?php else: ?>
                        <a class="navbar-item" href="<?php echo e(route('login')); ?>">Login</a>
                        <a class="navbar-item" href="<?php echo e(route('register')); ?>">Registracija</a>
                    <?php endif; ?>
                </div>
            </div>
            <!--navigation-->
            ...
            <div class="hero row">
                ...
                <div class="col-sm-6 col-sm-6 ipad">
                    <img class="ipad-screen img-responsive" src="<?php echo e(asset('images/login.jpg')); ?>"/>
                </div>

                <div><img class="mouse" src="<?php echo e(asset('images/mouse.svg')); ?>"></div>
